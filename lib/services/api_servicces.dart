...
//
  ...
  Future<void> placeOrder(
    ...
    final url = Uri.parse('$baseUrl/api/user/place-order/$loginId/$productId');
  ...
  Future<void> updateServiceStatusTech(
      BuildContext context, String id, String bookedDate) async {
    final url = Uri.parse(
        '$baseUrl/api/technician/update-complaint-stat/$id/$bookedDate');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content:
              Text('Failed to update service status: ${response.statusCode}'),
        ));
      }
    } catch (e) {
      // Request failed
...
//add rare parts
  Future<void> addSpareParts(
      BuildContext context, Map<String, dynamic> data, File imageFile) async {

...
class _CustomerOrderBookingListState extends State<CustomerOrderBookingList> {
  @override
                        ...
                        itemBuilder: (context, index) => Container(
                          ...
                          child: ListTile(
                            ...
                            leading: ClipRRect(
                              ...
                              child: Image.network(
                                  bookings[index]['products_data']['image']),
                            ),
                            title: Text(
                              bookings[index]['products_data']['brand'],
                            ...
                            subtitle: Text(DateFormat('dd-MM-yyyy').format(
                                DateTime.parse(bookings[index]['order_date']))),
                            trailing: IconButton(
                              onPressed: () {

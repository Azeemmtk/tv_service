...
import 'package:tv_service/modules/technician/parts_full_details.dart';
...
class _TechRarePartsScreensState extends State<TechRarePartsScreens> {
  ...
  Future<List<dynamic>> fetchRareParts() async {
    ...
    final response = await http
        .get(Uri.parse('${ApiServices.baseUrl}/api/user/view-spareparts'));
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Partsfulldetails(
                              image: rareParts[index]['image'],
                              details: rareParts[index]),
                        ));
                  },
                  child: SizedBox(
                    height: 150,
